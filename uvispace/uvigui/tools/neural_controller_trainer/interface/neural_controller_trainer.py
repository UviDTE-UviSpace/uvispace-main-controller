...
class Ui_fuzzy_window(object):
    def setupUi(self, fuzzy_window):
        ...
        self.verticalLayout_plot_test = QtWidgets.QVBoxLayout()
        self.verticalLayout_plot_test.setSpacing(6)
        self.verticalLayout_plot_test.setObjectName("verticalLayout_plot_test")
        self.verticalLayout_5.addLayout(self.verticalLayout_plot_test)
        self.verticalLayout_plot_sim = QtWidgets.QVBoxLayout()
        self.verticalLayout_plot_sim.setSpacing(6)
        self.verticalLayout_plot_sim.setObjectName("verticalLayout_plot_sim")
        self.verticalLayout_5.addLayout(self.verticalLayout_plot_sim)
