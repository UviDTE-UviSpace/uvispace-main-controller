...
y_trajectory = np.append(np.sin(np.linspace(90 * np.pi / 180,0.01 * np.pi / 180, 90)) * 0.4 + 0.8,
                         np.sin(np.linspace(180 * np.pi / 180, 539.99 * np.pi / 180, 360)) * 0.4 + 0.8)
x_trajectory = np.append(x_trajectory,np.cos(np.linspace(360 * np.pi / 180, 300 * np.pi / 180, 90)) * 0.4 -1.5)
y_trajectory = np.append(y_trajectory, np.sin(np.linspace(360 * np.pi / 180, 300 * np.pi / 180, 90)) * 0.4 + 0.8)
